...
import { Tree } from "metabase/components/tree/index_dl";
...
import { SidebarCollectionLinkDL, SidebarLink } from "./SidebarItems";
import {
  AddYourOwnDataLink,
  BrowseLink,
  CollectionMenuList,
      ...
      <div>
        {pathname === "/" && (
          <SidebarSection>
            <ul>
              <HomePageLink
                isSelected={nonEntityItem && nonEntityItem.url === "/"}
                icon="home"
        ...
        {(pathname.startsWith("/collection") ||
          ...
          <SidebarSection>
            ...
            <Tree
              data={collections}
              selectedId={collectionItem && collectionItem.id}
              onSelect={onItemSelect}
              TreeNode={SidebarCollectionLinkDL}
              role="tree"
              currentUser={currentUser}
              handleCreateNewCollection={handleCreateNewCollection}
              ...
              <SidebarSection>
                ...
                <BrowseLink
                  ...
                  isSelected={
                    nonEntityItem &&
                    nonEntityItem.url &&
                    nonEntityItem.url.startsWith(BROWSE_URL)
                  }
                  onClick={onItemSelect}
                ...
                {!hasOwnDatabase && isAdmin && (
                  <AddYourOwnDataLink
                    ...
                    isSelected={
                      nonEntityItem &&
                      nonEntityItem.url &&
                      nonEntityItem.url.startsWith(ADD_YOUR_OWN_DATA_URL)
                    }
                    onClick={onItemSelect}
...
export default MainNavbarViewNew;
